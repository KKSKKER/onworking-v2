...
export type ApiCommand =
  ...
  | { cmd: 'mapping.save'; folder: string; headerRow?: number; mappings: unknown[] }
  | { cmd: 'pipeline.list' }
  ...
  | { cmd: 'setup.preview'; filePath: string; sheetName?: string; headerRow?: number; offset?: number; limit?: number }
